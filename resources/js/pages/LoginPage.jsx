            ...
            <main className="flex-grow flex items-center justify-center px-4 py-12 relative z-10">
                <div className="w-full max-w-[440px] rounded-[1rem] p-10 ambient-shadow"
                    ...
                    <div className="flex flex-col gap-3 mb-8">
                        <button className="flex items-center justify-center gap-3 w-full py-3.5 rounded-lg font-semibold text-sm transition-all hover:bg-[#eeeeed]"
                        ...
                        <button className="flex items-center justify-center gap-3 w-full py-3.5 rounded-lg font-semibold text-sm transition-all hover:bg-[#eeeeed]"
                            style={{background:'#f3f4f3', color:'#1a1c1c'}}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="#1a1c1c">
